...
dataset_avg <- aggregate(dataset_mean_sd[,2:67], by = list(labels = dataset_mean_sd$labels, subjects = dataset_mean_sd$subjects),FUN = mean)
write.csv(dataset_avg, file="C:/Users/juc71/datasciencecoursera/GettingCleaningData/UCI_HAR_Dataset/dataset_avg.csv")
write.table(dataset_avg, file="C:/Users/juc71/datasciencecoursera/GettingCleaningData/UCI_HAR_Dataset/dataset_avg.txt")
